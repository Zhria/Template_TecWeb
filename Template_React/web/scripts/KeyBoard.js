...
class KeyBoard extends React.Component {
    ...
    render() {
        return (
            ...
            {/*Ovviamente creo i bottoni appositi*/} 
            
            <button name="log" onClick={this.props.onClick}>Log(x)</button>
            <button name="e" onClick={this.props.onClick}>e^(x)</button>
            <button name="1/x" onClick={this.props.onClick}>1/x</button>
            </div>
        );
    }
}
